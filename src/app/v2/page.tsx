import GlassTermsAndPrivacy from "../components/GlassTermsAndPrivacy";
import GlassBackground from "../components/ui/GlassBackground";
import GlassContainer from "../components/ui/GlassContainer";

export default function Home() {
    return (
        <div className="relative min-h-screen min-w-screen bg-dark-background text-white overflow-scroll">
            <GlassBackground />
